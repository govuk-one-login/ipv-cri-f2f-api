...
echo "F2F backend URL $DEV_CRI_F2F_API_URL"
echo $DEV_IPV_F2F_STUB_URL
echo $DEV_F2F_EXPIRED_ACCESS_TOKEN
echo $DEV_F2F_MISSING_SUB_ACCESS_TOKEN
echo $DEV_F2F_YOTI_STUB_URL
