...
export class SendEmailService {
	...
	async sendGovNotification(message: Email, encoded: string | undefined): Promise<EmailResponse | undefined> {
	...
	async fetchInstructionsPdf(message: Email): Promise<string | undefined> {
