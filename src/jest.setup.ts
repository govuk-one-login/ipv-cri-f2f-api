...
process.env.CLIENT_CONFIG = '[{"jwksEndpoint":"https://api.identity.account.gov.uk/.well-known/jwks.json","clientId":"ipv-core-stub","redirectUri":"http://localhost:8085/callback","YOTIBASEURL": "https://XXX-proxy.review-o.dev.account.gov.uk/yoti","YOTISDK": "1f9edc97-c60c-40d7-becb-c1c6a2ec4963"}]'
