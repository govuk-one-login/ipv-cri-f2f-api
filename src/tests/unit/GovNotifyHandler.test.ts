...
import {ssmClient} from "../../utils/SSMClient";

const mockedSendEmailRequestProcessor = mock<SendEmailProcessor>();
const mockedSsmClient = mock<SSMClient>();
...
// jest.mock("../../utils/SSMClient", () => {
// 	return {
// 		ssmClient: jest.fn(() => mockedSsmClient),
// 	};
// });
describe("GovNotifyHandler", () => {
	...
	// 	mockedSsmClient.send.mockReturnThis();
	...
	// 	});
	// 	ssmClient.send.mockResolvedValue({Parameter:{Value:"sdgsdg"}});
