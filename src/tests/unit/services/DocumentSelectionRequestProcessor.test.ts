...
function getYotiSessionInfo(): YotiSessionInfo {
	const yotiSessionInfo: YotiSessionInfo = {
		"session_id":"b83d54ce-1565-42ee-987a-97a1f48f27df",
...
describe("DocumentSelectionRequestProcessor", () => {
	...
	beforeAll(() => {
		mockDocumentSelectionRequestProcessor = new DocumentSelectionRequestProcessor(logger, metrics, YOTI_PRIVATE_KEY);
		// @ts-ignore
