...
describe("GenerateVerifiableCredential", () => {
	...
	describe("calculateStrengthScore", () => {
		it("should return the correct strength score for PASSPORT valid chip", () => {
			const documentType = "PASSPORT";
		...
		it.skip("should return the correct strength score for EU identity card without valid chip", () => {
			const documentType = "EUIDENTITYCARD";
			const documentContainsValidChip = false;
		...
		it("should throw an error for an invalid document type", () => {
			...
			expect(() =>
				generateVerifiableCredential["calculateStrengthScore"](documentType, documentContainsValidChip),
	...
	describe("getCounterIndicator", () => {
		...
		it("should throw an error for an unexpected face match rejection reason", () => {
			const ID_DOCUMENT_FACE_MATCH_RECOMMENDATION = {
				value: "REJECT",
			...
			expect(() =>
				generateVerifiableCredential["getCounterIndicator"](
					ID_DOCUMENT_FACE_MATCH_RECOMMENDATION,
					null,
					null,
					null,
			...
			).toThrow("Unexpected reason for rejection");
		});

		// Add more test cases for other rejection reasons and combinations
	});
